...
KRYO_BASE_URL := http://maven.aliyun.com/nexus/content/groups/public/com/esotericsoftware/kryo/kryo/$(KRYO_VERSION)
...
REFLECTASM_BASE_URL := http://maven.aliyun.com/nexus/content/groups/public/com/esotericsoftware/reflectasm/reflectasm/$(REFLECTASM_VERSION)
...
ASM_BASE_URL := http://maven.aliyun.com/nexus/content/groups/public/org/ow2/asm/asm/$(ASM_VERSION)
...
MINLOG_BASE_URL := http://maven.aliyun.com/nexus/content/groups/public/com/esotericsoftware/minlog/minlog/$(MINLOG_VERSION)
